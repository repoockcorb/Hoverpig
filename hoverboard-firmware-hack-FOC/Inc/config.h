...
*/
  // #define DUAL_INPUTS                     // ADC*(Primary) + PPM(Auxiliary). Uncomment this to use Dual-inputs
    ...
    #define CONTROL_PPM_RIGHT     0       // use PPM-Sum as input on the RIGHT cablTANK_STEERINGe. Number indicates priority for dual-input. Disable CONTROL_SERIAL_USART3!
