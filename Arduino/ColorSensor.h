...
#include "veml6040.h"
#include "btstack_run_loop.h" // Add btstack header for thread-safe callbacks
...
float getSpeedMultiplier();  // Get current speed boost multiplier
void processRumbleRequests(); // Process pending rumble requests from the main thread
...
extern const float SPEED_BOOST_MULTIPLIER;  // Speed boost amount when active
